...
import { DeleteNotificacaoService } from '../services/DeleteNotificacaoService'
...
export class DeleteNotificacaoController {
	async handle(req: Request, res: Response) {
		try {
			...
			const deleteNotificacaoService = new DeleteNotificacaoService(notificacoesRepository)

			await deleteNotificacaoService.execute(data, req.user!.id)
