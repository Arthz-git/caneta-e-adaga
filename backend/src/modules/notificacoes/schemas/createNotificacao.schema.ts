...
export const createNotificacaoSchema = z.object({
	...
	tipo: z.enum(['SOLICITACAO_RECEBIDA', 'SOLICITACAO_ACEITA', 'SOLICITACAO_RECUSADA', 'NOVO_POST_MESA', 'POST_PRIVADO', 'JOGADOR_REMOVIDO_MESA', 'MESA_EXCLUIDA'], 'Tipo inválido'),
